...
public class Main {
	public static void main(String[] args) {
		...
		// String outputdir =
		// "D:/echo/lab/research/co-change/ICSE-2018/data/change-relation-count-rank";
		...
		// "D:/echo/lab/research/co-change/ICSE-2018/data/change-relation-count-rank";
		// String outputdir =
		// "D:/echo/lab/research/co-change/ICSE-2018/data/dsm";
		// DSMGenerator generator = new DSMGenerator(gitRepository);
		// generator.generateTopNRelationTopNFilePairDSM(inputdir, outputdir,
		// 32, 20);
