...
public class RelationParser {
	...
	public RelationParser(GitRepository repository) {
	...
	public static void main(String args[]) {
		...
		// RelationParser a=new
		// RelationParser(gitRepository,"camel","D:\\Workspace\\co-change
		// summer\\understand\\camel\\");
		// a.extractRelation();
		// GitRepository gitRepository = new GitRepository(2, "cassandra",
		// "D:/echo/lab/research/co-change/projects/cassandra/.git");
		// RelationParser a=new
		// RelationParser(gitRepository,"cassandra","D:\\Workspace\\co-change
		// summer\\understand\\cassandra\\");
		// a.extractRelation();
		// GitRepository gitRepository = new GitRepository(3, "cxf",
		// "D:/echo/lab/research/co-change/projects/cxf/.git");
		// RelationParser a=new
		// RelationParser(gitRepository,"cxf","D:\\Workspace\\co-change
		// summer\\understand\\cxf\\");
		// a.extractRelation();
		// GitRepository gitRepository = new GitRepository(4, "hadoop",
		// "D:/echo/lab/research/co-change/projects/hadoop/.git");
		// RelationParser a=new
		// RelationParser(gitRepository,"hadoop","D:\\Workspace\\co-change
		// summer\\understand\\hadoop\\");
		// a.extractRelation();
		// GitRepository gitRepository = new GitRepository(5, "hbase",
		// "D:/echo/lab/research/co-change/projects/hbase/.git");
		// RelationParser a=new
		// RelationParser(gitRepository,"hbase","D:\\Workspace\\co-change
		// summer\\understand\\hbase\\");
		// a.extractRelation();
		GitRepository gitRepository = new GitRepository(6, "wicket",
				"D:/echo/lab/research/co-change/projects/wicket/.git");
		RelationParser a = new RelationParser(gitRepository);
		String inputDir = "D:\\Workspace\\co-change summer\\understand\\wicket\\";
		a.extractRelation(inputDir);
	}

	public void extractRelation(String inputDir) {
		ArrayList<File> files = getListFiles(new File(inputDir));
		for (File f : files) {
			if (f.getAbsolutePath().endsWith("xml")) {
				System.out.println("Begin parse file " + f.getName());
				parseFile(f, inputDir);
				// System.exit(0);
			}
		}
	...
	private void parseFile(File f, String outputDir) {
		...
		structureDSM.write2StructureDSM(outputDir + this.repository.getRepositoryName() + "_structureDSM.dsm");
		structureDSM = null;
		historyDSM = new GenerateDSM(fileList);
		List<FilePairCount> dataList = FilePairCountDAO.selectByRepositoryIdAndCount(this.repository.getRepositoryId(),
				0);
		...
		historyDSM.write2HistoryDSM(outputDir + this.repository.getRepositoryName() + "_historyDSM.dsm");
